...
public class Demo {
	...
	public static void main(String[] args) {
		...
		ArrayList l= new ArrayList(); // ArrayList is Predefined Class in java.Util Package So you have to Import the ArrayList Class
		...
		// indexOf() methods is used to the index position of an Object and first occurrence in case of duplication
		...
		System.out.println(x.lastIndexOf(10));  // lastIndexOf() method is print the last Object  in occurrence of case of duplication
	}
