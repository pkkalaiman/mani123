...
<body>
	<nav class="navbar navbar-expand-lg-navbar-Light bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"> <img
				...
				href="SignIn.jsp" class="btn btn-warning">SignIn</a>
	...
	<form action="unique" method="post" class="container col-30 col-sm-30 col-md-5 shadow-lg p-5 mb-5 bg-white mx-auto d-block border border-primary rounded-lg 
m-5 pb-5 bg-i  nfo">
		<pre>
	...
	<script>
		...
		function ValidName() {
			...
			console.log(uservalue);
			xhttp.open("GET", "http://localhost:8080/Project-Mani/userName/"
					+ uservalue);
			xhttp.send();
		...
		function ValidMobile() {
			...
			console.log('Running in ajax');
			console.log(userMobilevalue);
			xhttp.open("GET", "http://localhost:8080/Project-Mani/mobile/"
					+ userMobilevalue);
			xhttp.send();
			xhttp.onload = function() {
				console.log(this);
