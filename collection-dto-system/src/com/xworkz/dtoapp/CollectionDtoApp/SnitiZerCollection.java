...
public class SnitiZerCollection {
	...
	public static void main(String[] args) {
		...
		/*
		 * for(SanitizerDto sanni : col) {
		 * System.out.println(sanni); }
		 * 
		 */
		
		for(Object element :sanitizer) {
		...
		for(SanitizerDto element :sanitizer) {
			
			System.out.println(sanitizer.contains(null));
